...
void Debugg::lancerSerieTests() {
	...
	// Test #12 put king in check and restrain mouvements (opposite color).
	{
		try {
			...
			if (movePtr2 == nullptr) {
				...
				movePtr3->setEndSquare(chessGame_.getEchiquier()->getCase(6, 4));
				movePtr3->executeMove(chessGame_.getEchiquier());
				this->chessGame_.determineNextStates();
			}
			...
			if (movePtr4 == nullptr) {
				...
				movePtr4->setEndSquare(chessGame_.getEchiquier()->getCase(0, 0));
				movePtr4->executeMove(chessGame_.getEchiquier());
				this->chessGame_.determineNextStates();
			}
	...
	// Test #13 put king in check and block check (opposite color).
	{
		try {
			...
			if (movePtr4 == nullptr) {
				...
				movePtr4->setEndSquare(chessGame_.getEchiquier()->getCase(1, 4));
				movePtr4->executeMove(chessGame_.getEchiquier());
				this->chessGame_.determineNextStates();
			}
			std::cout << "Test passed" << std::endl;
	...
	// Test #14 put king in check and restrain mouvements (opposite color).
	{
		try {
			...
			// move #3
			std::unique_ptr<Move> movePtr3 = this->chessGame_.createMoveObject(chessGame_.getEchiquier()->getCase(1, 0));
			if (movePtr2 == nullptr) {
				std::cout << "Move was illegal" << std::endl;
			}
			else {
				movePtr3->setEndSquare(chessGame_.getEchiquier()->getCase(1, 4));
				movePtr3->executeMove(chessGame_.getEchiquier());
				this->chessGame_.determineNextStates();
			}

			// move #4
			std::unique_ptr<Move> movePtr4 = this->chessGame_.createMoveObject(chessGame_.getEchiquier()->getCase(0, 4));
			if (movePtr4 == nullptr) {
				std::cout << "Move was illegal" << std::endl;
			}
			else {
	...
	/* //Test #12 legal-move illigal-move legal-move (opposite color).
	{
		try {
			std::cout << "Test #12" << std::endl;
			 move #1
			...
			if (movePtr2 == nullptr) {
				...
				movePtr2->setEndSquare(chessGame_.getEchiquier()->getCase(0, 2));
				movePtr2->executeMove(chessGame_.getEchiquier());
				this->chessGame_.determineNextStates();
			}
